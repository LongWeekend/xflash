...
{
  STAssertTrue([CardPeer keywordIsHeadword:@"納バ"],@"Should be considered headword");
  STAssertTrue([CardPeer keywordIsHeadword:@"納 "],@"Should be considered headword");
  STAssertTrue([CardPeer keywordIsHeadword:@"納　"],@"Should be considered headword");
  STAssertTrue([CardPeer keywordIsHeadword:@"納?"],@"Should be considered headword");
  ...
  STAssertTrue([CardPeer keywordIsHeadword:@"人?馬?"],@"Should be considered headword");
  STAssertTrue([CardPeer keywordIsHeadword:@"人?馬"],@"Should be considered headword");
  STAssertTrue([CardPeer keywordIsHeadword:@"人馬?"],@"Should be considered headword");
  STAssertTrue([CardPeer keywordIsHeadword:@"人 馬?"],@"Should be considered headword");
  STAssertTrue([CardPeer keywordIsHeadword:@"人納 "],@"Should be considered headword");
}
