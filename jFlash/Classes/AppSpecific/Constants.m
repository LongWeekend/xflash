...
"dfn{ text-shadow:none; font-weight:normal; color:#000; position:relative; top:-1px; font-family:verdana; font-size:10.5px; background-color:#C79810; line-height:10.5px; margin:4px 4px 0px 0px; height:14px; padding:2px 3px; -webkit-border-radius:4px; border:1px solid #F9F7ED; display:inline-block;} "
".button{ font-size:12px; padding: 2px 4px; display: inline; background: #777; border: none; color: #fff; font-weight: bold; border-radius: 3px; -moz-border-radius: 3px; -webkit-border-radius: 3px; text-shadow: 1px 1px #666; background-color: #58aa00;} "
...
".HeadwordCell { vertical-align:top; border-right:none; font-size:13px; } "
".ContentCell { vertical-align:top; border-left:none; font-size:13px; } "
"##THEMECSS##</style></head>"
"<body><div id='container'>";
