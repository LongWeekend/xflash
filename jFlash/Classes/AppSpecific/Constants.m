...
".ExpandedSentencesTable { width:100%; border:2px dashed; border-collapse:collapse; margin: 10px 0px 5px 0px; } "
...
".HeadwordCell { white-space:nowrap; vertical-align:top; border-right:none; } "
".ContenttCell { white-space:nowrap; vertical-align:top; border-left:none; } "
"##THEMECSS##</style></head>"
"<body><div id='container'>";
