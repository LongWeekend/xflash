...
".readingLabel {font-size:14px;font-weight:bold; margin-top:3px;} "
".headwordLabel {font-size:19px; margin:0px 0px 9px 0px;color:yellow;text-shadow:black 0px 1px 0px;} "
"##THEMECSS##</style></head>"
"<body><div id='container'>";
