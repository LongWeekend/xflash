  ...
  if (self = [super init])
  {
    ...
    _availablePlugins = [[NSDictionary alloc] initWithObjectsAndKeys:
                          ...
                          [NSDictionary dictionaryWithObjectsAndKeys:
                           ...
                           @"",@"plugin_notes_file",
                           @"http://mini.local/~paul/jFlash-CARDS-1.1.db.gz",@"target_url",
                           ...
                           [NSDictionary dictionaryWithObjectsAndKeys:
                            ...
                            @"http://mini.local/~paul/jFlash-FTS-1.1.db.gz",@"target_url",
                           ...
                           [NSDictionary dictionaryWithObjectsAndKeys:
                            ...
                            @"http://mini.local/~paul/jFlash-EX-1.1.db.gz",@"target_url",
