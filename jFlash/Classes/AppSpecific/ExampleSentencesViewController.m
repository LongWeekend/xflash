...
"<style>"
"body{ background-color: transparent; margin:0; padding: 0 14px; box-sizing:border-box; width:100%; text-align:left; line-height:21px; font-size:16px; font-weight:bold; font-family:Helvetica,sanserif; color:#fff; } "
...
"ol{ color:white; text-align:left; width:100%; box-sizing:border-box; margin:0px; padding-left:24px; } "
