...
public class ChineseCard extends Card
{

    private String headword_simp;
    ...
    public void hydrate(Cursor inCursor)
    {
        ...
        int tempColumn = inCursor.getColumnIndex("headword_simp");
        headword_simp = inCursor.getString(tempColumn);

        tempColumn = inCursor.getColumnIndex("headword_trad");
        headword = inCursor.getString(tempColumn);
    }


    // override of Card.hydrate(Cursor  ) that includes ChineseCard
    // relevant columns from the database
    @Override
    ...
    // TODO - yikes
    public String pinyinForNumberedPinyin(String inPinyin)
    {
        return null;
    }
...
*/
    ...
    public void setHeadwordSimp(String inWord)
    {
        headword_simp = inWord;
    }

    public String getHeadwordSimp()
    {
        return headword_simp;
    }



}  // end ChineseCard class declaration
