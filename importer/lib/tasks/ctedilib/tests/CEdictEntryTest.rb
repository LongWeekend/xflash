...
#堆壘數論 堆垒数论 [dui1 lei3 shu4 lun4] /additive number theory (math.)/
  ...
  def test_to_insert_sql
    ...
    expected = "INSERT INTO cards_staging (headword_trad,headword_simp,headword_en,reading,reading_diacritic,meaning,meaning_html,meaning_fts,classifier,entry_tags,referenced_cards,is_reference_only,is_variant,is_erhua_variant,is_proper_noun,variant,priority_word,cedict_hash) VALUES ('旁邊兒','旁边儿','lateral','pang2 bian1 r5','páng biān r','lateral; side; to the side; beside','<ol><li>lateral</li><li>side</li><li>to the side</li><li>beside</li></ol>','lateral side beside',NULL,'',NULL,0,1,1,0,'旁邊|旁边',0,'%s');" % cedict_hash
