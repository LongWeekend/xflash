...
# crunchyt a~/t crunchytoast.com 2010-04-01
#
...
#		s=s.strip.gsub(/nn$/,'n').gsub(/nn([^a-z|A-Z]+)/,'n\1')   # Fix "nn" appearing at end of line or word
  ...
  # ADDED PCHAPMAN 2009-05-12 22:31
  # ADDED PCHAPMAN 2009-05-12 22:31
  def kana2kana(str1)
    result = []
