...
Script: TextboxList.js
	...
	Extended:
	2009-05-29  PCHAPMAN  Added container ID option to start supporting multiple inputs on page
*/
...
TextboxList = function(element, _options){
    ...
    containerId: element.replace(/#/gi,'') + '-textboxlist',
	...
	var init = function(){		
		...
		container = $('<div id="'+ options.containerId +'" class="'+options.prefix+'" />')
			.insertAfter(element)
			.click(function(e){ 
	...
	// EXTENDED: 2009-05-29   PCHAPMAN  Added public method to clear the box's contents
	var clearSelection = function(){
	  $("#" + options.containerId + " .textboxlist-bit-box-deletebutton").click();
	};
...
TextboxList.Autocomplete = function(textboxlist, _options){
	...
	var options = $.extend(true, {
		...
		method: 'standard',
		placeholder: 'Type for tag suggestions'
	}, _options);
