...
ActiveRecord::Schema.define(:version => 20111220083022) do
  ...
  create_table "cards_search_content", :id => false, :force => true do |t|
    t.integer "card_id",                  :default => 0,     :null => false
    t.string  "headword", :limit => 511,  :default => "",    :null => false
    t.string  "reading",  :limit => 511,  :default => "",    :null => false
    t.string  "content",  :limit => 3000,                    :null => false
    t.boolean "ptag",                     :default => false, :null => false
  end
